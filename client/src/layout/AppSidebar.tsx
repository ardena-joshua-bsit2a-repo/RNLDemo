  ...
  return (
    <>
      ...
      <aside
        ...
        } sm:translate-x-0 bg-slate-900 text-white border-r border-slate-800`}
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-2 font-medium">
            {sidebarItems.map((sidebarItem) => (
              <li key={sidebarItem.text}>
                <Link
                  to={sidebarItem.path}
                  className="flex items-center px-2 p-2 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group"
                >
